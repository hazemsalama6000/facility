	...
	setDefaultForForm() {
		...
		if (this.data.companyId != 0) {  //for edit
			...
			this.companyDataForm = this.fb.group({
				...
				commercialRecord: ['', Validators.compose([Validators.required, Validators.minLength(4), Validators.maxLength(6)])],
				taxCardNo: ['', Validators.compose([Validators.required,  Validators.minLength(9), Validators.maxLength(12)])],
