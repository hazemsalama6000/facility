...
@Component({
	...
	templateUrl: './car-expense-upsert-list-content.component.html',
	styleUrls: ['./car-expense-upsert-list-content.component.scss'],
	changeDetection:ChangeDetectionStrategy.OnPush
})

export class CarExpenseListContentComponent {
