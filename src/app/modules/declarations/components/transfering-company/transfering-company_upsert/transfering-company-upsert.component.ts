...
@Component({
	selector: 'transfering-company-upsert',
	templateUrl: './transfering-company-upsert.component.html',
	styleUrls: ['./transfering-company-upsert.component.scss'],
	changeDetection: ChangeDetectionStrategy.OnPush

})

export class TransferingCompanyUpsertComponent {
