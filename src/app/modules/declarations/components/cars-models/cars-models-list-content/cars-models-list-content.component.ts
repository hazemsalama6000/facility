...
@Component({
	selector: 'cars-models-list-content',
	templateUrl: './cars-models-list-content.component.html',
	styleUrls: ['./cars-models-list-content.component.scss'],
	changeDetection:ChangeDetectionStrategy.OnPush
})

export class CarsModelsListContentComponent {
	...
	constructor(private service: CarsModelsService, private toaster: toasterService 
